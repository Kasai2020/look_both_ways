...
class UNISAL(BaseModel, utils.KwConfigClass):
    ...
    def __init__(self,
        ...
        print(rnn_input_channels,rnn_hidden_channels,cnn_cfg,rnn_cfg,res_rnn,bypass_rnn,drop_probs)
        print(gaussian_init,n_gaussians,smoothing_ksize,bn_momentum,static_bn_momentum,sources)
        print(ds_bn,ds_adaptation,ds_smoothing,ds_gaussians,verbose)
        # Check inputs
